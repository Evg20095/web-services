...
def hello():
    print(1+2)
    return '<h1>Hello, Vse polychitsya :)) you are super<h1>'
...
def iris(param):
    ...
    flower_class = predict
    flower_class = float(flower_class)

    if flower_class == 0:
        return '<h1>Hello, Sertosa is name this flower<h1><img src="/static/setosa.jpg" alt="Setosa">' 
    
    if flower_class == 1:
        return '<h1>Hello, Versicolor is name this flower<h1><img src="/static/versicolor.jpg" alt="Versicolor">'
    
    if flower_class == 2:
        return '<h1>Hello, Virginica is name this flower<h1><img src="/static/virginica.jpg" alt="Virginica">'
